                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="portlet light portlet-fit portlet-form ">
                                ...
                                <!-- BEGIN FORM-->
                                    <form action="{{url('password/forget')}}" method="post" id="forget_form" class="form-horizontal" accept-charset="UTF-8">
                                        {{csrf_field()}}
                                        <div class="form-body">
                                            <div class="form-group {{$errors->has('forgotten_email') || session('message') ? 'has-error' : ''}}">
                                                <label for="forgotten_email" class="control-label col-md-3">البريد الإلكتروني  <span class="required">*</span></label>
                                                <div class="col-md-9">
                                                    <input type="text" name="forgotten_email" class="form-control" id="forgotten_email" value="{{old('forgotten_email')}}" autofocus/>
                                                    @if($errors->has('forgotten_email'))
                                                        <div class="help-block help-block-error">{{$errors->first('forgotten_email')}}</div>
                                                    @endif
                                                    @if(session('message'))
                                        ...
                                        <div class="form-actions">
                                            <div class="row">
                                                <div class="col-md-offset-3 col-md-9">
                                                    <a href="/login" class="btn btn-default"><i class="fa fa-undo"></i>  إلغاء</a>
                                                    <button type="submit" class="btn green"><i class="fa fa-send"></i>  إرسال</button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
...
<script src="{{asset('assets/layouts/layout3/scripts/forget_form.js') }}" type="text/javascript"></script>
