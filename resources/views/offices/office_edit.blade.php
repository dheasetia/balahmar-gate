    ...
    <div class="portlet light bordered">
        <div class="portlet-title">
            <div class="caption">
                ...
                <span class="caption-helper">تعديل الجهة </span>
            </div>
            <div class="actions">
                <a class="btn btn-circle btn-icon-only" href="/office" title="إلغاء">
                    <i class="fa fa-undo font-balahmar"></i>
                </a>
                <a class="btn btn-circle btn-icon-only" title="خفظ"
        ...
        <!-- BEGIN FORM-->
            <form action="/office" method="post" class="form-horizontal form-bordered form-row-stripped" id="form_edit_office" accept-charset="utf-8" enctype="multipart/form-data">
                {{csrf_field()}}
                {{method_field('patch')}}
                ...
                <div class="form-body">
                    ...
                    <div class="form-group {{$errors->has('license_file') ? 'has-error' : ''}}">
                        <label class="control-label col-md-3"> {{$office->license_file == '' ? 'صورة الترخيص' : 'تغيير صورة الترخيص'}}</label>
                        <div class="col-md-3">
                    ...
                    <div class="form-group {{$errors->has('bank_id') ? 'has-error' : ''}}">
                        ...
                        <div class="col-md-9">143143fdsafdsafsdafsadf
                    ...
                    <div class="form-group {{$errors->has('bank_file') ? 'has-error' : ''}}">
                        <label class="control-label col-md-3"> {{$office->bank_file == '' ? 'صورة شهادة الحساب البنكي ' : 'تغيير صورة شهادة الحساب البنكي '}} </label>
                        <div class="col-md-3">
                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                <div class="input-group input-large">
                                    <div class="form-control uneditable-input input-fixed input-medium" data-trigger="fileinput">
