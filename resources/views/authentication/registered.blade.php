            ...
            <div class="container">
                ...
                <div class="page-content-inner">
                    <div class="m-heading-1 border-green m-bordered">
                        <h3>قمتَ بعملية التسجيل ... </h3>
                        <p>نحن نقوم بالتأكد من صحة البريد الإلكتروني ورقم الهاتف المسجل في حسابك. لتفعيل حسابك، الرجاء متابعة التعليمات المرسلة بالبريد الإلكتروني الخاص بك.</p>
                        <p>إذا لم تجد الرسالة، قد تكون في صندوق الرسائل غير المرغوبة.</p>
                    </div>
                </div>
