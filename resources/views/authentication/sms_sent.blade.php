                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="portlet light portlet-fit portlet-form ">
                                ...
                                <!-- BEGIN FORM-->
                                    <form action="{{url('password/reset')}}" method="post" class="form-horizontal" accept-charset="UTF-8">
                                        {{csrf_field()}}
                                        ...
                                        <div class="form-body">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group form-md-line-input {{$errors->has('otp') | isset($message)? 'has-error' : ''}}">
                                                        <label class="col-md-4 control-label" for="otp">الرمز المرسل لجوالك</label>
                                                        <div class="col-md-8">
                                                            <div class="input-group">
                                                                <span class="input-group-addon">
                                                                    <i class="fa fa-mobile"></i>
                                                                </span>
                                                                <input type="text" class="form-control" id="otp" name="otp" value="{{old('otp')}}" autofocus>
                                                                <div class="form-control-focus"> </div>
                                                                <span class="help-block">أربعة أرقام إنجليزي</span>
                                                                @if($errors->has('otp'))
                                                                    <div class="help-block help-block-error">{{$errors->first('otp')}}</div>
                                                                @endif
                                                                @if(isset($message))
                                                                    <div class="help-block help-block-error">{{$message}}</div>
                                                                @endif
                                                            </div>
                                                        </div>
                                                    </div>
