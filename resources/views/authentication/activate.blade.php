                            ...
                            <div class="portlet light portlet-fit portlet-form ">
                                ...
                                <div class="portlet-body">
                                    @if(session('error'))
                                        <div class="row">
                                            <div class="col-md-12">
                                                    <div class="alert alert-danger" role="alert">الرمز غير صحيح.</div>
                                            </div>
                                        </div>
                                    @endif
                                <!-- BEGIN FORM-->
                                    <form action="{{url('activation')}}" method="post" class="form-horizontal" id="form_registration" accept-charset="UTF-8">
                                        {{csrf_field()}}
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="form-actions text-right">
                                                        <button type="submit" class="btn green"><i class="fa fa-send"></i> إرسال الرمز </button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
