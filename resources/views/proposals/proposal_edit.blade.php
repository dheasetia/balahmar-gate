...
@section('content')
    <div class="portlet light bordered">
        ...
        <div class="portlet-body form">
            ...
            @endif
            <!-- BEGIN FORM-->
            <form action="{{url('proposals', $proposal->id)}}" method="post" class="form-horizontal form-bordered form-row-stripped" id="form_create_proposal" accept-charset="utf-8" enctype="multipart/form-data">
                {{csrf_field()}}
                {{method_field('patch')}}
                <div class="form-body">
                    ...
                    <div class="form-group {{$errors->has('hijri_created') ? 'has-error' : ''}}">
                        ...
                        <div class="col-md-2">
                            <input type="text" name="hijri_created" class="form-control" id="hijri_created" value="{{old('hijri_created', $proposal->hijri_created_day . '/ ' . $proposal->hijri_created_month . '/ ' . $proposal->hijri_created_year)}}" readonly/>
                    ...
                    <div class="form-group {{$errors->has('project_name') ? 'has-error' : ''}}">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="project_name" class="form-control" id="project_name" value="{{old('project_name',  $proposal->project_name)}}"/>
                            @if($errors->has('name'))
                    ...
                    <div class="form-group {{$errors->has('description') ? 'has-error' : ''}}">
                        ...
                        <div class="col-md-9">
                            <textarea name="description" class="form-control" id="description" rows="5">{{old('description', $proposal->description)}}</textarea>
                    ...
                    <div class="form-group {{$errors->has('execution_date') ? 'has-error' : ''}}">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="execution_date" class="form-control" id="execution_date" value="{{old('execution_date', $proposal->hijri_execution_day . '/ ' . $proposal->hijri_execution_month . '/ ' . $proposal->hijri_execution_year)}}"/>
                    ...
                    <div class="form-group {{$errors->has('responsible_person') ? 'has-error' : ''}}">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="responsible_person" class="form-control" id="responsible_person" value="{{old('responsible_person', $proposal->responsible_person)}}"/>
                    ...
                    <div class="form-group {{$errors->has('mobile') ? 'has-error' : ''}}">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="mobile" class="form-control" id="mobile" value="{{old('mobile', $proposal->mobile)}}"/>
                    ...
                    <div class="form-group {{$errors->has('email') ? 'has-error' : ''}}">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="email" class="form-control" id="email" value="{{old('email', $proposal->email)}}"/>
                            @if($errors->has('email'))
                        ...
                        <div class="col-md-9">
                            <select class="form-control" name="kind_id" id="kind_id" >
                                ...
                                @foreach($kinds as $kind)
                                    <option value="{{$kind->id}}" {{old('kind_id', $proposal->kind_id) == $kind->id ? 'selected' : ''}}>{{$kind->name}}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-9">
                            <select class="form-control" name="city_id" id="city_id" >
                                ...
                                @foreach($cities as $city)
                                    <option value="{{$city->id}}" {{old('city_id', $proposal->city_id) == $city->id ? 'selected' : ''}}>{{$city->name}}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="form-group {{$errors->has('video_link') ? 'has-error' : ''}}">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="video_link" class="form-control" id="video_link" value="{{old('video_link', $proposal->video_link)}}"/>
...
@section('page_scripts')
    <script src="{{asset('assets/layouts/layout3/scripts/proposal_edit.js') }}" type="text/javascript"></script>
@endsection