        ...
        <div class="portlet light portlet-fit">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-helper">تم إيقاف استقبال المشاريع منها</span>
                </div>
                <div class="actions">
            ...
            <div class="portlet-body">
                <table class="table table-bordered table-striped" id="office_list_table">
                    ...
                    <tbody>
                    @if(count($suspended_offices) == 0)
                        <tr>
                            <td colspan="6" class="text-center"><h4>لا توجد جهة تم إيقاف استقبال المشاريع منها</h4></td>
                        </tr>
                    @else
                        @foreach($suspended_offices as $office)
                            <tr>
                                    ...
                                    @else
                                        @if($office->is_approved == 1)
                                            ...
                                            @if($office->is_suspended == 1)
                                                <span class="label label-danger">إيقاف مشاريع</span>
                                            @endif
                                        @else
