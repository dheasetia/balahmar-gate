                        ...
                        <div class="col-md-12">
                            @if(session('error'))
                                <div class="alert alert-danger">
                                    ada yang keliru bah: {{session('error')}}
                                </div>
                            @endif
                            ...
                            <div class="portlet light portlet-fit portlet-form ">
                                ...
                                <div class="portlet-body">
                                    <!-- BEGIN FORM-->
                                    <form action="{{url('user/need_activation')}}" method="post" class="form-horizontal" id="form_registration" accept-charset="UTF-8">
                                        {{csrf_field()}}
                                        <div class="form-body">
                                            <p>يبدو أن حسابك غير مفعل، اضغط على زر الإرسال لنرسل لك الرابط في البريد الإلكتروني الخاص بك.</p>
                                            <div class="row">
                                                <div class="col-md-12">
