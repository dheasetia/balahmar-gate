        ...
        <div class="col-md-12">
            <div class="portlet light ">
                ...
                <div class="portlet-body form">
                    <form action="{{url('/messages', $message->id)}}" method="post" accept-charset="utf-8" enctype="multipart/form-data" id="form_message_create" role="form" class="form-horizontal form-bordered form-row-stripped">
                        {{csrf_field()}}
                        {{method_field('patch')}}
