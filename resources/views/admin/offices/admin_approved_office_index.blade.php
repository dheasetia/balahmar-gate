    ...
    <div class="col-md-12">
        ...
        <div class="portlet light portlet-fit">
            <div class="portlet-title">
                ...
                <div class="actions">
                    <a href="{{url('admin/offices/approved')}}" class="btn btn-icon-only btn-circle tooltips" data-original-title="تحديث"><i class="fa fa-refresh font-balahmar"></i></a>
            ...
            <div class="portlet-body">
                <table class="table table-bordered table-striped" id="office_list_table">
                    ...
                    <tbody>
                    @if(count($approved_offices) == 0)
                        <tr>
                            <td colspan="6" class="text-center"><h4>لا توجد جهة معتمدة</h4></td>
                        </tr>
                    @else
                        @foreach($approved_offices as $office)
                            <tr>
