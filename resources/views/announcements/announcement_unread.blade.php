            ...
            <div class="portlet light ">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-helper">الإشعارات غير المقروءة</span>
                    </div>
                    <div class="actions">
                        <a href="/announcements/unread" class="btn btn-icon-only btn-circle btn-default tooltips" data-original-title="تحديث القائمة"><i class="fa fa-refresh"></i></a>
                    </div>
                </div>
                <div class="portlet-body">
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                        @if(count($unread_announcements) > 0)
                            @foreach($unread_announcements as $announcement)
