...
<div class="portlet light ">
    <div class="portlet-title tabbable-line">
        ...
        <div class="actions">
            <a href="{{url('/messages/create')}}" class="btn btn-icon-only btn-circle tooltips" data-original-title="رسالة جديدة"><i class="fa fa-plus"></i></a>
        </div>
    </div>
                            ...
                            <div class="mt-comment">
                                ...
                                <div class="mt-comment-body">
                                    ...
                                    <div class="mt-comment-text">
                                        <a href="{{url('messages', $item->id)}}" class="tooltips" data-original-title="مشاهدة الرسالة">
                                            @if(Helpers::getMessageRecipientDetail(Sentinel::getUser()->id, $item->id)->is_read == 0)
                                                <i class="fa fa-eye default"></i> &nbsp; <span class="font-red bold">{{$item->subject}} [{!! str_limit(strip_tags($item->body), 50) !!}]</span>
                                            @else
                                                <i class="fa fa-eye font-balahmar"></i> &nbsp; <span class="blue-hoki">{{$item->subject}} [{!! str_limit(strip_tags($item->body), 50) !!}]</span>
                                            @endif
                                        </a>
                                    </div>
                                </div>
                        ...
                        @foreach($outbox as $item)
                            <div class="mt-comment">
                                ...
                                <div class="mt-comment-body">
                                    ...
                                    <div class="mt-comment-text"><a href="{{url('messages', $item->id)}}" class="tooltips" data-original-title="مشاهدة الرسالة">
                        ...
                        @foreach($drafts as $item)
                            <div class="mt-comment">
                                ...
                                <div class="mt-comment-body">
                                    ...
                                    <div class="mt-comment-text">
                                        <a href="{{url('messages', $item->id)}}" class="tooltips" data-original-title="مشاهدة الرسالة">
                                            <strong class="font-blue-chambray">{{$item->subject}}</strong> [{!! str_limit(strip_tags($item->body), 50) !!}]
                                        </a>
                                    </div>
