        ...
        <div class="portlet light portlet-fit ">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-helper">قائمة جميع الجهات</span>
                </div>
                <div class="actions">
                    <a href="{{url('admin/offices')}}" class="btn btn-icon-only btn-circle tooltips" data-original-title="تحديث"><i class="fa fa-refresh font-balahmar"></i></a>
            ...
            <div class="portlet-body">
                <table class="table table-bordered table-striped" id="office_list_table">
                    ...
                    @if(count($offices) == 0)
                        <tr>
                            <td colspan="6" class="text-center"><h4>لا توجد جهة مسجلة</h4></td>
                        </tr>
                    @else
