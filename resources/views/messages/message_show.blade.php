            ...
            <div class="portlet light portlet-fit ">
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        ...
                        <a href="{{url('/messages', $message_id)}}" class="btn btn-icon-only btn-circle btn-default tooltips" data-original-title="تحديث"><i class="fa fa-refresh"></i></a>
                    </div>
                </div>
                <div class="portlet-body">
                    <div class="timeline">
                        ...
                        <div class="timeline-item">
                            ...
                            <div class="timeline-body {{$message->id == $message_id ? 'active' : ''}}">
                                ...
                                <div class="timeline-body-head">
                                    <div class="timeline-body-head-caption">
                                        ...
                                        @else
                                            <span class="timeline-body-title font-blue-madison"><a href="{{url('users', $message->creator->id)}}" class="tooltips" data-original-title="تفاصيل الشخص">{{$message->creator->name}}</a></span>
                                        @endif
